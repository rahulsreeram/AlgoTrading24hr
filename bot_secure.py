...
# === CONFIG ===
# Use environment variables for API keys (more secure for deployment)
API_KEY = os.getenv("BINANCE_API_KEY", "48d79f2d43e209df9c9ac7297cef874d4a9692ac3c098f4c3e9867992067521e")
API_SECRET = os.getenv("BINANCE_API_SECRET", "83920167cd9db8c02cc7733beb2e44d3c0a409f8aa666f6385cb2010db9999c9")
